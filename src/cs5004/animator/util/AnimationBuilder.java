...
/**
 * This is the AnimationBuilder interface. The purpose of this builder is to to
 * connect the given parsing code with the model
 * 
 * @author shishuai
 *
 * @param <Doc> the placeholder of generic type
 */
